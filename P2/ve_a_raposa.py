...
template = cv2.imread('madfox.png',0)
...
while(True):
    ...
    circles=cv2.HoughCircles(bordas,cv2.HOUGH_GRADIENT,2,40,param1=50,param2=100,minRadius=5,maxRadius=60)
        ...
        #    cv2.rectangle(bordas_color,(i[0],i[1]),i[2],(0,255,0),2)
            # draw the center of the circle
        #    cv2.rectangle(bordas_color,(i[0],i[1]),2,(0,0,255),3)


        # cv2.rectangle(img, pt1, pt2, color[, thickness[, lineType[, shift]]])
        #cv2.rectangle(bordas_color,(384,0),(510,128),(0,255,0),3)
            #print("tem uma raposa ai fera")
